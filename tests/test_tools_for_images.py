"""
Tests for ToolsForImages functionality.
...
class TestToolsForImages:
    """Test suite for ToolsForImages conversions."""

    @pytest.fixture
    def image_tools(self) -> ToolsForImages:
        """Create ToolsForImages instance."""
        return ToolsForImages()

    def test_itk_to_sitk_scalar_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_sitk_to_itk_scalar_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_roundtrip_scalar_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_itk_to_sitk_vector_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_sitk_to_itk_vector_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_roundtrip_vector_image(self, image_tools: ToolsForImages) -> None:
    ...
    def test_imwrite_imread_vd3(
        ...
        # Generate a deformation field using ToolsForTransforms
...
class TestFlipImage:
    """Unit tests for ToolsForImages.flip_image (axis flips and direction reset)."""
    ...
    def test_flip_xy_combines_flips(self, image_tools: ToolsForImages) -> None:
    ...
    def test_no_flip_returns_same_image(self, image_tools: ToolsForImages) -> None:
...
class TestResampleImageByScale:
    """Unit tests for ToolsForImages.resample_image_by_scale."""
    ...
    def test_physical_extent_is_preserved(
        self, image_tools: ToolsForImages, scale: float
    ) -> None:
    ...
    def test_direction_is_unchanged(self, image_tools: ToolsForImages) -> None:
