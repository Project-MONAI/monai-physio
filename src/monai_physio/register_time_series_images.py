...
class RegisterTimeSeriesImages(RegisterImagesBase):
    ...
    def set_fixed_image(self, fixed_image: itk.Image) -> None:
        ...
        # A composite built on the previous fixed image's grid would silently
        # mismatch reconstruction against this one; force composite_mode
        # "existing" to raise rather than reuse it.
