...
This module provides the ToolsForTransforms class with utilities for working with
...
class ToolsForTransforms(MONAIPhysioBase):
    """
    ...
    def __init__(self, log_level: int | str = logging.INFO):
        """Initialize the ToolsForTransforms class.
    ...
    def transform_dataset(
        ...
        if with_deformation_magnitude:
            ...
            if cp is not None:
                try:
                    import cupy_backends.cuda.api.runtime as _cuda_rt
    ...
    def smooth_deformation_field_transform(
        ...
        smoothed_field = ToolsForImages().convert_array_to_image_of_vectors(
    ...
    def combine_transforms_with_masks(
        ...
        combined_field = ToolsForImages().convert_array_to_image_of_vectors(
    ...
    def compute_jacobian_determinant_from_field(self, field: itk.Image) -> itk.Image:
        ...
        if "VF" not in str(type(field)):
            field_arr = itk.array_from_image(field)
            field = ToolsForImages().convert_array_to_image_of_vectors(
    ...
    def reduce_folding_in_field(
        ...
        corrected_field = ToolsForImages().convert_array_to_image_of_vectors(
            field_arr, field, itk.F
        )
