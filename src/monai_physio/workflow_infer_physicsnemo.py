...
:class:`monai_physio.WorkflowEvaluateMovement`. The network itself is supplied
...
imported lazily so ``import monai_physio`` works without them.
"""
    ...
    def __init__(
        ...
        Args:
            model_directory: Directory written by
                :class:`monai_physio.WorkflowTrainPhysicsNeMo` (holds
            ...
            inference_method: Inference method carrying the network. Defaults to
                a new :class:`monai_physio.InferPhysicsNeMoMGN`.
