...
--------
  ...
  %(prog)s \\
    ...
    try:
        from .. import ToolsForContours, WorkflowConvertImageToVTK
    ...
    try:
        if args.output_mode == "combined":
            ...
            surface_file = ToolsForContours.save_combined_surfaces(
            ...
            saved_surfaces = ToolsForContours.save_surfaces(
